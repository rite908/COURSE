  ...
  return (
    ...
    >
      ...
      <div className="nav-px" style={{
        ...
        {/* ── Desktop nav links — centered (CSS-controlled) ── */}
        ...
        {/* ── Desktop right actions (CSS-controlled) ── */}
        ...
        {/* ── Mobile right: theme toggle + hamburger (CSS-controlled) ── */}
